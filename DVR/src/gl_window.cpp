...
glWindow::glWindow(const Controller& controller) : glWindow { 800, 600, "Window", controller } {}

glWindow::glWindow(uint32_t width, uint32_t height, const std::string_view name, const Controller& controller) {
