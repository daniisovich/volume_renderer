...
namespace dvr {
	namespace gl {
		...
		Texture2D::Texture2D(GLenum internal_format, const std::array<uint32_t, 2>& size) : m_id{} {
		...
		Texture2D::Texture2D(GLenum format, GLenum internal_format, const std::array<uint32_t, 2>& size, GLenum data_type, const std::vector<uint8_t>& data,
		...
		void Texture2D::activate(GLuint texture_unit) const {
