...
namespace gl_debug {
...
#ifndef NDEBUG
	std::map<GLenum, const char*> debug_type{ {GL_DEBUG_TYPE_ERROR, "Error"}, {GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR, "Deprecated"}, {GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR, "Undefined"},
	...
	std::map<GLenum, const char*> debug_severity{ {GL_DEBUG_SEVERITY_HIGH, "High"}, {GL_DEBUG_SEVERITY_MEDIUM, "Medium"}, 
